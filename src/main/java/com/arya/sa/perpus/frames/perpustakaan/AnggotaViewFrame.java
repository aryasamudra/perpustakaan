...
public class AnggotaViewFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        viewTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id Anggota", "Nama", "Alamat", "No Telpon", "Tanggal Lahir"
            }
        ) {
    ...
    private void cariButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cariButtonActionPerformed
        try {
            ...
            while(resultSet.next()){
                row[0] = resultSet.getInt("idanggota");
                row[1] = resultSet.getString("nama");
                row[2] = resultSet.getString("alamat");
                row[3] = resultSet.getString("notelp");
                row[4] = resultSet.getString("tgllahir");
                model.addRow(row);
            }
            koneksi.close();
        ...
        if(barisTerpilih >= 0){
            ...
            if(pilihan == 0){
                try {
                    ...
                    int id = (int) model.getValueAt(barisTerpilih, 0);
                    Connection koneksi = Basisdata.getConnection();
                    String deleteSQL = "DELETE FROM anggota WHERE idanggota="+id;
                    Statement statement = koneksi.createStatement();
