...
public class PeminjamanViewFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Cari Data Pinjam");
        ...
        viewTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "Nama Peminjam", "Nama Buku", "Tanggal Pinjam", "Tanggal Kembali"
            }
        ) {
        ...
        if (viewTable.getColumnModel().getColumnCount() > 0) {
            viewTable.getColumnModel().getColumn(0).setMinWidth(30);
            viewTable.getColumnModel().getColumn(0).setMaxWidth(30);
            viewTable.getColumnModel().getColumn(1).setMinWidth(190);
            viewTable.getColumnModel().getColumn(1).setMaxWidth(190);
            viewTable.getColumnModel().getColumn(2).setMinWidth(190);
            viewTable.getColumnModel().getColumn(2).setMaxWidth(190);
            viewTable.getColumnModel().getColumn(3).setMinWidth(100);
            viewTable.getColumnModel().getColumn(3).setMaxWidth(100);
    ...
    String selectSQL = "SELECT peminjaman.id, peminjaman.idanggota, anggota.nama, buku.judul, peminjaman.tglpinjam, peminjaman.tglkembali " +
                       "FROM peminjaman " +
                       "INNER JOIN anggota ON peminjaman.idanggota = anggota.idanggota " +
                       "INNER JOIN buku ON peminjaman.nobuku = buku.nobuku " +
                       "WHERE anggota.nama LIKE '%" + kataKunci + "%'";
    ...
    while (resultSet.next()) {
        ...
        row[3] = resultSet.getString("tglpinjam");
        row[4] = resultSet.getString("tglkembali");
        model.addRow(row);
    }
    koneksi.close();
...
setLocationRelativeTo(null);
    ...
    private void anggotaButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_anggotaButtonActionPerformed
        AnggotaViewFrame a = new AnggotaViewFrame();
        a.setVisible(true);
    ...
    private void bukuButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bukuButtonActionPerformed
        BukuViewFrame b = new BukuViewFrame();
        b.setVisible(true);
        // TODO add your handling code here:
